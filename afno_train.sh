...
#SBATCH --output=afno_train%A_%a.out      # Output file for each job (%A: jobID, %a: taskID)
#SBATCH --error=afno_train%A_%a.err        # Error file for each job
...
singularity exec --nv --bind /gpfs/scratch/bsc21/bsc580556/data_driven:/workspace /gpfs/scratch/bsc21/bsc580556/HOME/nvcr.io_nvidia_modulus_modulus_23.11-2023-11-20-547c0c1003cd.sif python /gpfs/scratch/bsc21/bsc580556/data_driven/afno.py #--id $SLURM_ARRAY_TASK_ID
